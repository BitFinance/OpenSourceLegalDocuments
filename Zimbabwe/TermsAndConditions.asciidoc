...
## 1. Preamble
Bitfinance provides an online platform (An Exchange) that allows users to trade in digital currencies such as bitcoin, Bitcoin Cash, Dash, Litecoin, Bitcoin Gold and Ethereum.
...
To the maximum extend permitted by law, Golix shall have no liability for any damages of any kind (including without limitation, indirect, special, incidental, consequential, or tort damages, or lost profits) in connection with your use of the services, even if Golix has been advised or is aware of the possibility of such damages. In no event will Golix’s liability for money damages under these terms exceed the amount of fees received from you during the preceding six (6) month period.
